---
layout: post
title: example1 part1.마크다운 기초
image: 
  path: /assets/img/blog/markdownshow.jpg
description: >
 example1 part1.마크다운 기초 설명
sitemap: false
...
{% include components/youtubePlayer.html id="BUTP-YsD3nM" %}

### 17.slick

<div class="main_center">
    <div><img src= "/assets/img/blog/example1/1.JPG" style="width: 700px; height: 500px; auto;"></div>
    <div><img src= "/assets/img/blog/example1/2.JPG" style="width: 700px; height: 500px; auto;"></div>
    <div><img src= "/assets/img/blog/example1/3.JPG" style="width: 700px; height: 500px; auto;"></div>
</div>
